<template>
  <v-container>
    ...
    <v-divider center style="width:300px" />
    <p class="u-text-center">
      ...
      <v-row center>
        <v-link squared href="https://github.com/FlorianWoelki" blank>
    ...
    <v-row center>
      <v-col c6>
        <Project
          ...
          description="I've created this project, to learn
      ...
      <v-col c6>
        <Project
          ...
          description="This library for iOS was written in Swift
