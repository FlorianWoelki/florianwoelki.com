...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeExperience
      {Web Team Lead}{2022 - today}
      {Complori / Codary}{Berlin, Germany}
      \resumeItemListStart
        \item
          {Led the web team building a more scalable and maintainable web architecture using technologies like \textbf{Google Cloud}, \textbf{React}, and \textbf{Next}, resulting in a decrease of the bundle size by over 30\%.}
          \vspace{-3.5pt}
        \item
