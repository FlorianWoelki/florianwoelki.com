...
\section{Skills}
  ...
  Redux \textbar{Tailwind} PyTorch \textbar{} Machine Learning \textbar{}
    ...
    \resumeExperience
      ...
      \resumeItemListStart
        \item
          ...
          \vspace{-3.5pt}
        \item
          {Built a real-time situational awareness dashboard with efficient event and KPI calculation using \textbf{Java}, \textbf{SpringBoot}, \textbf{Scala}, \textbf{Angular}, and \textbf{TypeScript}, to improve decision-making in critical situations.}
          \vspace{-3.5pt}
        \item
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{\href{https://sketchy-virid.vercel.app/}{sketchy}}
      {Prototype of animating SVG with a custom rendering engine.}
      \vspace{-5pt}
