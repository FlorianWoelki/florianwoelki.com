...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeExperience
      ...
      \resumeItemListStart
        \item
          {Introduced storybook to the web design system team, resulting in a better, developer friendly, and faster design system.}
          \vspace{-3.5pt}
        \item
          {Fixed a substantial bug that has produced over 500k errors, resulting in a 30\% decrease of errors in the backend.}
          \vspace{-3.5pt}
      \resumeItemListEnd
