...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Education Web App}
          {Leading the web team to build an education web application specifically for kids learning programming.
          (\textit{Next.js, TypeScript, Tailwind, Google Cloud})}
        \resumeItem{Interactive Web IDE}
          {Developing an scalable and interactive Web IDE for running code in the browser.
          (\textit{Go, Next.js, TypeScript, Tailwind, Google Cloud})}
      \resumeItemListEnd
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Artificial Intelligence}{2021 - 2024}
    \resumeSubheading
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Languages}
      {TypeScript, Javascript, Go, SQL, Python, Java, Rust}
    \resumeSubItem{Technologies}
      {Google Cloud, React, Vue, Angular, SpringBoot, Node.js, Docker, PyTorch}
  \resumeSubHeadingListEnd
