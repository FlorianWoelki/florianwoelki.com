...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Fullstack Softwarearchitect}{2022 - today}
      \resumeItemListStart
        \resumeItem{Education Web App}
          {Developing an education web application specifically for kids learning programming.
          (\textit{Next.js, TypeScript, Tailwind, Firebase})}
      \resumeItemListEnd
